package cn.danielw.fop.benchmark;
...
public class BenchmarkFastObjectPool extends Benchmark {
    ...
    BenchmarkFastObjectPool(int workerCount, int borrows, int loop) throws InterruptedException {
        super("fop-nod", workerCount, borrows, loop);
